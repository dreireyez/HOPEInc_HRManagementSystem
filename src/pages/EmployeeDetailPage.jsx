              ...
              <div className="flex-1 flex flex-col justify-between h-full py-2 w-full text-center md:text-left">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2.5 mb-2 mt-auto justify-center md:justify-start">
                    ...
                    <div className="px-3 py-1.5 rounded-full bg-[var(--color-surface-bright)] shadow-[0_2px_8px_rgba(12,31,56,0.04)] border border border-[var(--color-outline-variant)]/10 flex items-center gap-2 transition-transform hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(12,31,56,0.06)] cursor-default">
